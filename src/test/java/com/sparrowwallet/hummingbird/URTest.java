...
public class URTest {
    ...
    @Test
    public void testFindNominalFragmentLength() throws UR.InvalidCBORException, UR.InvalidTypeException {
        byte[] message = "Hello".getBytes();
        UR ur = UR.fromBytes(message);
        UREncoder urEncoder = new UREncoder(ur, 200, 100, 0);
    }
